...
KNOWLEDGE_BASE = [
    ...
    {"id": "gaudi3-arch", "text": "Intel Gaudi 3 accelerators are purpose-built for deep learning training and inference. Each Gaudi 3 device has 96GB of HBM2e memory and 24 Tensor Processor Cores. For large language model inference, Gaudi 3 provides 2x the throughput of the previous generation while maintaining cost efficiency."},
