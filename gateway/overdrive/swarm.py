...
INCIDENT_SWARM = {
    ...
    "description": "Specialized agents investigate a production incident in parallel across Intel Xeon 6 and GPU.",
    "agents": [
        {"id": "triage", "name": "Triage Agent", "role": "Classify severity and identify affected services", "hardware_lane": "xeon_eco", "task_type": "classification", "hw_label": "Intel Xeon 6 Eco", "model": "granite-2b-cpu"},
        {"id": "log_analyst", "name": "Log Analyst", "role": "Parse logs and find error patterns", "hardware_lane": "xeon_performance", "task_type": "rerank", "hw_label": "Intel Xeon 6 + AMX", "model": "phi3-mini-cpu"},
        {"id": "metrics", "name": "Metrics Agent", "role": "Analyze dashboards and interpret charts", "hardware_lane": "gaudi_overdrive", "task_type": "chart_interpretation", "hw_label": "Intel GPU", "model": "deepseek-r1-distill-qwen-14b"},
        {"id": "rca", "name": "RCA Agent", "role": "Deep root cause analysis combining all findings", "hardware_lane": "gaudi_overdrive", "task_type": "incident_rca", "hw_label": "Intel GPU", "model": "deepseek-r1-distill-qwen-14b"},
        {"id": "reporter", "name": "Reporter Agent", "role": "Synthesize findings into executive report", "hardware_lane": "gaudi_overdrive", "task_type": "batch_summary", "hw_label": "Intel GPU", "model": "deepseek-r1-distill-qwen-14b"},
        # Deep-level agents
        {"id": "security_analyst", "name": "Security Analyst", "role": "Check for security implications in the incident", "hardware_lane": "xeon_performance", "task_type": "rerank", "hw_label": "Intel Xeon 6 + AMX", "model": "phi3-mini-cpu"},
        {"id": "change_auditor", "name": "Change Auditor", "role": "Review recent deployments that may have caused the incident", "hardware_lane": "xeon_eco", "task_type": "classification", "hw_label": "Intel Xeon 6 Eco", "model": "granite-2b-cpu"},
        {"id": "remediation_planner", "name": "Remediation Planner", "role": "Generate detailed fix plan with rollback steps", "hardware_lane": "gaudi_overdrive", "task_type": "long_summary", "hw_label": "Intel GPU", "model": "deepseek-r1-distill-qwen-14b"},
    ],
    "waves": [
        {"wave": 1, "label": "Parallel Investigation", "agents": ["triage", "log_analyst", "metrics"], "depends_on": None, "desc": "Three agents investigate simultaneously — classification on Xeon 6, log analysis on Xeon 6 + AMX, dashboard interpretation on GPU."},
        {"wave": 2, "label": "Root Cause Analysis", "agents": ["rca"], "depends_on": 0, "desc": "RCA agent receives all findings from Wave 1 and performs deep analysis on GPU."},
        {"wave": 3, "label": "Report Generation", "agents": ["reporter"], "depends_on": 1, "desc": "Reporter synthesizes everything into an executive summary on GPU."},
        {"wave": 4, "label": "Validation & Remediation", "agents": ["security_analyst", "change_auditor", "remediation_planner"], "depends_on": 2, "desc": "Security review, change audit, and remediation planning run in parallel across Xeon 6 and GPU."},
    ],
    "depth_config": {
...
SECURITY_AUDIT_SWARM = {
    ...
    "agents": [
        {"id": "vuln_scanner", "name": "Vulnerability Scanner", "role": "Scan for known CVEs and misconfigurations", "hardware_lane": "xeon_eco", "task_type": "classification", "hw_label": "Intel Xeon 6 Eco", "model": "granite-2b-cpu"},
        {"id": "compliance", "name": "Compliance Checker", "role": "Verify against CIS benchmarks and SOC2 controls", "hardware_lane": "xeon_performance", "task_type": "rerank", "hw_label": "Intel Xeon 6 + AMX", "model": "phi3-mini-cpu"},
        {"id": "threat_analyst", "name": "Threat Analyst", "role": "Analyze threat vectors and attack surface", "hardware_lane": "gaudi_overdrive", "task_type": "incident_rca", "hw_label": "Intel GPU", "model": "deepseek-r1-distill-qwen-14b"},
        {"id": "risk_assessor", "name": "Risk Assessor", "role": "Prioritize findings by business impact", "hardware_lane": "gaudi_overdrive", "task_type": "long_summary", "hw_label": "Intel GPU", "model": "deepseek-r1-distill-qwen-14b"},
        {"id": "reporter", "name": "Audit Reporter", "role": "Generate executive security audit report", "hardware_lane": "gaudi_overdrive", "task_type": "batch_summary", "hw_label": "Intel GPU", "model": "deepseek-r1-distill-qwen-14b"},
        # Deep-level agents
        {"id": "network_auditor", "name": "Network Auditor", "role": "Analyze network policies, ingress rules, and TLS configuration", "hardware_lane": "xeon_performance", "task_type": "rerank", "hw_label": "Intel Xeon 6 + AMX", "model": "phi3-mini-cpu"},
        {"id": "secrets_scanner", "name": "Secrets Scanner", "role": "Detect exposed secrets, tokens, and credentials in configs", "hardware_lane": "xeon_eco", "task_type": "classification", "hw_label": "Intel Xeon 6 Eco", "model": "granite-2b-cpu"},
        {"id": "remediation_planner", "name": "Remediation Planner", "role": "Generate prioritized remediation roadmap with timelines", "hardware_lane": "gaudi_overdrive", "task_type": "long_summary", "hw_label": "Intel GPU", "model": "deepseek-r1-distill-qwen-14b"},
    ],
    "waves": [
        {"wave": 1, "label": "Parallel Scanning", "agents": ["vuln_scanner", "compliance", "threat_analyst"], "depends_on": None, "desc": "Three agents scan simultaneously — CVE detection on Xeon 6, compliance checks on Xeon 6 + AMX, threat analysis on GPU."},
        {"wave": 2, "label": "Risk Assessment", "agents": ["risk_assessor"], "depends_on": 0, "desc": "Risk assessor prioritizes all findings from Wave 1 by business impact on GPU."},
        {"wave": 3, "label": "Audit Report", "agents": ["reporter"], "depends_on": 1, "desc": "Reporter generates the executive security audit report on GPU."},
...
CAPACITY_PLANNING_SWARM = {
    ...
    "agents": [
        {"id": "resource_analyst", "name": "Resource Analyst", "role": "Analyze current CPU, GPU, memory utilization across nodes", "hardware_lane": "xeon_eco", "task_type": "classification", "hw_label": "Intel Xeon 6 Eco", "model": "granite-2b-cpu"},
        {"id": "traffic_modeler", "name": "Traffic Modeler", "role": "Model request patterns, peak hours, and seasonal trends", "hardware_lane": "xeon_performance", "task_type": "rerank", "hw_label": "Intel Xeon 6 + AMX", "model": "phi3-mini-cpu"},
        {"id": "growth_modeler", "name": "Growth Modeler", "role": "Project resource needs based on growth trajectory", "hardware_lane": "gaudi_overdrive", "task_type": "long_summary", "hw_label": "Intel GPU", "model": "deepseek-r1-distill-qwen-14b"},
        {"id": "cost_optimizer", "name": "Cost Optimizer", "role": "Identify cost reduction opportunities across hardware tiers", "hardware_lane": "gaudi_overdrive", "task_type": "incident_rca", "hw_label": "Intel GPU", "model": "deepseek-r1-distill-qwen-14b"},
        {"id": "reporter", "name": "Capacity Reporter", "role": "Generate executive capacity planning report", "hardware_lane": "gaudi_overdrive", "task_type": "batch_summary", "hw_label": "Intel GPU", "model": "deepseek-r1-distill-qwen-14b"},
        # Deep-level agents
        {"id": "bin_packer", "name": "Bin Packing Optimizer", "role": "Optimize workload placement across Xeon 6 and GPU nodes", "hardware_lane": "xeon_performance", "task_type": "rerank", "hw_label": "Intel Xeon 6 + AMX", "model": "phi3-mini-cpu"},
        {"id": "sla_auditor", "name": "SLA Auditor", "role": "Verify capacity meets SLA commitments under projected load", "hardware_lane": "xeon_eco", "task_type": "classification", "hw_label": "Intel Xeon 6 Eco", "model": "granite-2b-cpu"},
        {"id": "procurement_planner", "name": "Procurement Planner", "role": "Generate hardware procurement timeline with ROI analysis", "hardware_lane": "gaudi_overdrive", "task_type": "long_summary", "hw_label": "Intel GPU", "model": "deepseek-r1-distill-qwen-14b"},
    ],
    "waves": [
        {"wave": 1, "label": "Data Collection", "agents": ["resource_analyst", "traffic_modeler", "growth_modeler"], "depends_on": None, "desc": "Three agents collect data simultaneously — utilization on Xeon 6, traffic patterns on Xeon 6 + AMX, growth modeling on GPU."},
        ...
        {"wave": 3, "label": "Capacity Report", "agents": ["reporter"], "depends_on": 1, "desc": "Reporter generates the executive capacity planning report on GPU."},
...
SCENARIO_NARRATIVES = {
    "incident": {
        ...
        "story": "A P1 production incident has been triggered: checkout service degradation with GPU memory pressure. The swarm dispatches specialized agents to investigate, analyze, and report — fast tasks on Xeon 6, heavy reasoning on GPU.",
    },
    "security_audit": {
