...
INCIDENT_SWARM = {
    ...
    "agents": [
        ...
        {"id": "metrics", "name": "Metrics Agent", "role": "Analyze dashboards and interpret charts", "hardware_lane": "gaudi_overdrive", "task_type": "chart_interpretation", "hw_label": "Intel Gaudi", "model": "deepseek-r1-distill-qwen-14b"},
        {"id": "rca", "name": "RCA Agent", "role": "Deep root cause analysis combining all findings", "hardware_lane": "gaudi_overdrive", "task_type": "incident_rca", "hw_label": "Intel Gaudi", "model": "deepseek-r1-distill-qwen-14b"},
        {"id": "reporter", "name": "Reporter Agent", "role": "Synthesize findings into executive report", "hardware_lane": "gaudi_overdrive", "task_type": "batch_summary", "hw_label": "Intel Gaudi", "model": "deepseek-r1-distill-qwen-14b"},
        # Deep-level agents
        ...
        {"id": "remediation_planner", "name": "Remediation Planner", "role": "Generate detailed fix plan with rollback steps", "hardware_lane": "gaudi_overdrive", "task_type": "long_summary", "hw_label": "Intel Gaudi", "model": "deepseek-r1-distill-qwen-14b"},
    ],
    "waves": [
...
SECURITY_AUDIT_SWARM = {
    ...
    "agents": [
        ...
        {"id": "threat_analyst", "name": "Threat Analyst", "role": "Analyze threat vectors and attack surface", "hardware_lane": "gaudi_overdrive", "task_type": "incident_rca", "hw_label": "Intel Gaudi", "model": "deepseek-r1-distill-qwen-14b"},
        {"id": "risk_assessor", "name": "Risk Assessor", "role": "Prioritize findings by business impact", "hardware_lane": "gaudi_overdrive", "task_type": "long_summary", "hw_label": "Intel Gaudi", "model": "deepseek-r1-distill-qwen-14b"},
        {"id": "reporter", "name": "Audit Reporter", "role": "Generate executive security audit report", "hardware_lane": "gaudi_overdrive", "task_type": "batch_summary", "hw_label": "Intel Gaudi", "model": "deepseek-r1-distill-qwen-14b"},
        # Deep-level agents
        ...
        {"id": "remediation_planner", "name": "Remediation Planner", "role": "Generate prioritized remediation roadmap with timelines", "hardware_lane": "gaudi_overdrive", "task_type": "long_summary", "hw_label": "Intel Gaudi", "model": "deepseek-r1-distill-qwen-14b"},
    ],
    "waves": [
...
CAPACITY_PLANNING_SWARM = {
    ...
    "agents": [
        ...
        {"id": "growth_modeler", "name": "Growth Modeler", "role": "Project resource needs based on growth trajectory", "hardware_lane": "gaudi_overdrive", "task_type": "long_summary", "hw_label": "Intel Gaudi", "model": "deepseek-r1-distill-qwen-14b"},
        {"id": "cost_optimizer", "name": "Cost Optimizer", "role": "Identify cost reduction opportunities across hardware tiers", "hardware_lane": "gaudi_overdrive", "task_type": "incident_rca", "hw_label": "Intel Gaudi", "model": "deepseek-r1-distill-qwen-14b"},
        {"id": "reporter", "name": "Capacity Reporter", "role": "Generate executive capacity planning report", "hardware_lane": "gaudi_overdrive", "task_type": "batch_summary", "hw_label": "Intel Gaudi", "model": "deepseek-r1-distill-qwen-14b"},
        # Deep-level agents
        {"id": "bin_packer", "name": "Bin Packing Optimizer", "role": "Optimize workload placement across Xeon 6 and Gaudi nodes", "hardware_lane": "xeon_performance", "task_type": "rerank", "hw_label": "Intel Xeon 6 + AMX", "model": "phi3-mini-cpu"},
        ...
        {"id": "procurement_planner", "name": "Procurement Planner", "role": "Generate hardware procurement timeline with ROI analysis", "hardware_lane": "gaudi_overdrive", "task_type": "long_summary", "hw_label": "Intel Gaudi", "model": "deepseek-r1-distill-qwen-14b"},
    ],
    "waves": [
