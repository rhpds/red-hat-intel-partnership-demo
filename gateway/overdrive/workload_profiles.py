...
SCENARIO_PROMPTS = {
    "incident_storm": {
        ...
        "embedding": [
            ...
            "Generate embedding for: 'GPU accelerator HBM utilization reached 97% causing inference queue backup.'",
        ],
        "rerank": [
        ...
        "long_summary": [
            "Generate comprehensive incident timeline: From initial GPU memory pressure alert through full platform degradation, failover to Xeon 6, and recovery. Include all 47 alerts, operator actions, and automated responses.",
        ],
        "incident_rca": [
            "Root cause analysis: The GPU accelerator lane went offline at 14:23 UTC. 142 requests experienced SLA violations. Investigate the chain from batch_summary job consuming all HBM through cascade to gateway timeout.",
            "Deep analysis: Why did the fallback from GPU to Xeon 6 Performance lane take 4 minutes instead of the expected 30 seconds? Examine routing matrix evaluation, health check intervals, and connection pool state.",
        ],
        "batch_summary": [
    ...
    "rag_barrage": {
        "embedding": [
            "Embed this knowledge base article: How to configure Intel GPU device plugin on OpenShift 4.15+",
            ...
            "Index document: Intel GPU HBM bandwidth specifications and workload sizing guidelines",
        ],
        "rerank": [
            "Rerank 10 documentation pages against: 'How to optimize model serving latency on Intel hardware'",
            "Score relevance of 6 KB articles for: 'GPU out of memory error during batch inference with 17B model'",
            "Cross-encoder rerank: Query='OpenShift route timeout configuration' against 8 candidate docs",
        ],
        "rag_question": [
            "Using the retrieved context, answer: What is the maximum model size that can run on a single GPU card without model parallelism?",
            "Based on the documentation, explain: How does the routing engine decide between Xeon 6 and GPU for a completion request?",
            "Answer from knowledge base: What are the recommended resource limits for a vLLM CPU inference pod on Xeon 6?",
            "RAG synthesis: Compare the throughput characteristics of Granite-tiny on Xeon 6 vs Llama-Scout-17B on GPU for classification tasks.",
        ],
        "document_summary": [
    ...
    "token_cannon": {
        "long_summary": [
            ...
            "Comprehensive comparison: vLLM serving on Intel GPU vs CPU-only deployment — covering throughput, latency, cost, power efficiency, and workload suitability across model sizes from 1B to 70B parameters.",
        ],
        "batch_summary": [
        ...
        "document_summary": [
            "Distill the complete Intel GPU architecture whitepaper: tensor engine specifications, HBM2E bandwidth, inter-die connectivity, software stack integration with PyTorch and vLLM, and performance benchmarks across LLM sizes.",
        ],
        "code_summary": [
    ...
    "model_race": {
        ...
        "long_summary": [
            "Detailed performance comparison: Run identical classification, summarization, and generation tasks on Xeon 6 (eco lane) vs Xeon 6 (performance lane) vs GPU (overdrive lane). Report latency, throughput, and cost per token for each.",
        ],
        "document_summary": [
            "Summarize the platform architecture document covering dual-path inference routing across Intel Xeon 6 and GPU hardware, including the Overdrive lane evaluation engine, rubric-based decision framework, and failover mechanisms.",
        ],
    },
}
...
SCENARIO_NARRATIVES = {
    "incident_storm": {
        ...
        "phases": [
            ...
            {"name": "Deep Analysis", "tasks": ["long_summary", "incident_rca"], "hw": "GPU", "desc": "Complex root cause analysis and detailed timelines are generated on GPU — these need the memory bandwidth and throughput for large context windows."},
            {"name": "Overnight Report", "tasks": ["batch_summary"], "hw": "GPU", "desc": "End-of-shift batch reports aggregate all incidents and generate capacity planning recommendations on GPU."},
        ],
    },
    "rag_barrage": {
        "title": "High-Throughput RAG Pipeline",
        "story": "An enterprise knowledge base is being queried at scale. Engineers are asking questions about Intel hardware configuration, OpenShift deployment, and model optimization. Every question triggers an embed-search-rerank-generate pipeline that spans both Xeon 6 and GPU.",
        "phases": [
            ...
            {"name": "Answer Generation", "tasks": ["rag_question"], "hw": "Mixed", "desc": "Simple questions answered on Xeon 6. Complex multi-document synthesis routed to GPU for deeper reasoning."},
            {"name": "Document Distillation", "tasks": ["document_summary"], "hw": "GPU", "desc": "Long technical documents are condensed into actionable summaries on GPU's high-bandwidth memory."},
        ],
    },
    "token_cannon": {
        "title": "Maximum Generation Throughput",
        "story": "The platform is stress-tested with the heaviest generation workloads — long analyses, batch reports, document distillation, and codebase reviews. Nearly everything routes to GPU because these tasks demand large context windows and sustained token generation.",
        "phases": [
            {"name": "Long Analysis", "tasks": ["long_summary"], "hw": "GPU", "desc": "Multi-page technical analyses generated on GPU at 100+ tokens/sec."},
            {"name": "Batch Reports", "tasks": ["batch_summary"], "hw": "GPU", "desc": "Week-long telemetry aggregated into comprehensive reports on GPU's HBM."},
            {"name": "Document Distillation", "tasks": ["document_summary"], "hw": "GPU", "desc": "40+ page whitepapers condensed on GPU using the full 400K token context window."},
            {"name": "Code Review", "tasks": ["code_summary"], "hw": "GPU", "desc": "Codebase analysis and optimization recommendations generated on GPU."},
        ],
    },
    "model_race": {
        "title": "Cross-Hardware Performance Comparison",
        "story": "The same types of tasks are run across all three hardware tiers to demonstrate why hardware-aware routing matters. Small tasks prove Xeon 6 is faster and cheaper. Large tasks prove GPU is essential for throughput.",
        "phases": [
            ...
            {"name": "Large Tasks → Overdrive", "tasks": ["long_summary", "document_summary"], "hw": "GPU", "desc": "Heavy generation on Llama Scout 17B — only viable on GPU's HBM bandwidth."},
        ],
    },
}
...
PROFILES = {
    ...
    "dashboard_storm": {
        ...
        "narrative": {"title": "Dashboard Storm", "story": "Operational dashboards are flooding the platform with screenshots. Xeon 6 classifies and sorts them instantly. GPU explains the high-value screenshots that need attention.", "phases": []},
        "prompts": {
            ...
            "chart_interpretation": ["Interpret this time-series chart showing p99 latency increasing from 200ms to 4,500ms over 15 minutes.", "What does this throughput chart indicate about the relationship between request volume and GPU utilization?"],
    ...
    "multimodal_incident_commander": {
        ...
        "narrative": {"title": "Multimodal Incident Commander", "story": "A production incident is unfolding. Screenshots, log snippets, and metrics are pouring in. Xeon 6 handles fast classification. GPU synthesizes everything into root cause analysis.", "phases": []},
        "prompts": {
            "screenshot_summary": ["Summarize the Grafana dashboard showing inference gateway latency spike during peak traffic."],
            "chart_interpretation": ["Interpret this error rate chart showing 502 errors correlating with GPU memory pressure."],
    ...
    "architecture_explainer": {
        ...
        "narrative": {"title": "Architecture Explainer", "story": "Architecture diagrams are submitted for AI-powered explanation. GPU handles the heavy vision-language reasoning to interpret complex system diagrams.", "phases": []},
        "prompts": {
            "diagram_explanation": ["Explain this architecture diagram showing the dual-path inference routing across Xeon 6 and GPU hardware.", "Describe the data flow shown in this Kubernetes deployment diagram with KServe ServingRuntimes."],
            "visual_rag_question": ["Looking at this architecture diagram, explain how the routing engine decides between Xeon 6 and GPU for each request.", "Based on this deployment diagram, what happens when the GPU accelerator node goes offline?"],
    ...
    "visual_rag_barrage": {
        ...
        "narrative": {"title": "Visual RAG Barrage", "story": "A multimodal knowledge base is queried at scale. Documents with images, diagrams, and screenshots are indexed, searched, and answered — spanning Xeon 6 for retrieval and GPU for synthesis.", "phases": []},
        "prompts": {
            "image_text_embedding": ["Embed this diagram and its caption for semantic search: Intel GPU accelerator architecture.", "Vectorize this screenshot and surrounding text for multimodal retrieval."],
            ...
            "visual_rag_question": ["Using the retrieved documents and screenshots, explain the inference routing decision flow.", "Based on these architecture diagrams and docs, how does failover work between Xeon 6 and GPU?"],
    ...
    "token_cannon_multimodal": {
        ...
        "narrative": {"title": "Token Cannon: Multimodal", "story": "Maximum multimodal generation throughput. Nearly everything routes to GPU because these tasks demand vision-language reasoning with large context windows.", "phases": []},
        "prompts": {
    ...
    "image_to_manual": {
        ...
        "prompts": {
            ...
            "image_to_manual": [
                "Generate a complete installation manual for the Intel GPU accelerator card shown in this image. Include safety precautions, hardware requirements, step-by-step installation, verification commands, and troubleshooting.",
