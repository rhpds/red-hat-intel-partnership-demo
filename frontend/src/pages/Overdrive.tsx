...
const LANE_META: Record<string, {
  ...
  eco: {
    ...
    accelerator: 'Xeon 6',
    capabilities: ['classification', 'short_summary', 'image_classification', 'screenshot_classification'],
    hwStory: 'Alert triage, text classification, and image classification on Xeon 6 via OpenVINO. $0.0004 per 1K tokens. No GPU overhead — AMX handles it in hardware.',
  },
  performance: {
    ...
    model: 'phi3-mini-cpu',
    accelerator: 'Xeon 6',
    capabilities: ['embedding', 'rerank', 'short_summary', 'long_summary', 'rag_question'],
    hwStory: 'Embeddings, reranking, and mid-range generation on Xeon 6 with OpenVINO. Fast enough for RAG pipelines, 10x cheaper than GPU. Ideal for knowledge base search and summaries.',
  },
  overdrive: {
