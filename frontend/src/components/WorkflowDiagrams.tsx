...
const workflows: Workflow[] = [
  {
    ...
    steps: [
      ...
      { label: 'Generate Answer', hw: 'gaudi', detail: 'deepseek-r1-distill-qwen-14b · <1s' },
    ],
  },
  {
    title: 'AIOps Copilot',
    ...
    steps: [
      { label: 'Classify Severity', hw: 'xeon6', detail: 'granite-2b-cpu · <1s' },
      { label: 'Find Similar Incidents', hw: 'xeon6', detail: 'nomic-embed · <500ms' },
      { label: 'Generate RCA', hw: 'gaudi', detail: 'deepseek-r1-distill-qwen-14b · <1s' },
      { label: 'Governance Gate', hw: 'xeon6', detail: 'granite-2b-cpu · risk eval' },
    ],
  },
  {
    ...
    steps: [
      { label: 'Classify Intent', hw: 'xeon6', detail: 'granite-2b-cpu · <1s' },
      { label: 'Score Risk', hw: 'xeon6', detail: 'granite-2b-cpu · risk scoring' },
      { label: 'Generate Plan', hw: 'gaudi', detail: 'deepseek-r1-distill-qwen-14b · <1s' },
      { label: 'Policy Check', hw: 'xeon6', detail: 'granite-2b-cpu · pass / fail' },
    ],
  },
];
